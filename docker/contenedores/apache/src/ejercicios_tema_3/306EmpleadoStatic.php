...
class Empleado {
    ...
    public static function getSueldoTope():int {return self::$sueldoTope;}


	public static function setSueldoTope( $nuevoSueldoTope): void {self::$sueldoTope = $nuevoSueldoTope;}
    ...
    public function pagaImpuestos(): string {
        return ($this->sueldo > self::$sueldoTope) ? "Si" :"No";
    }
...
$empleado->setSueldo(2030);
echo $empleado->getSueldo()."<br/>";
echo $empleado->pagaImpuestos()."<br>";
echo $empleado->getSueldoTope()."<br/>";
echo $empleado->setSueldoTope(20030);
echo $empleado->getSueldoTope(). "<br/>";
